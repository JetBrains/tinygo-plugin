...
public class AvrAsmArgumentImpl extends ASTWrapperPsiElement implements AvrAsmArgument {

  public AvrAsmArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AvrAsmMemory getMemory() {
    return findChildByClass(AvrAsmMemory.class);
  }
