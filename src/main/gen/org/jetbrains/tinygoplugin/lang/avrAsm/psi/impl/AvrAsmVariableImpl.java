...
public class AvrAsmVariableImpl extends ASTWrapperPsiElement implements AvrAsmVariable {

  public AvrAsmVariableImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AvrAsmSymbol getSymbol() {
    return findNotNullChildByClass(AvrAsmSymbol.class);
  }
