...
public class AvrAsmIndirectPostfixImpl extends ASTWrapperPsiElement implements AvrAsmIndirectPostfix {

  public AvrAsmIndirectPostfixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AvrAsmVisitor visitor) {
    visitor.visitIndirectPostfix(this);
  }
